  ...
  return (
    ...
    <MyPage>
      ...
      <MyPageBottom>
        ...
        <MyPageButton to="/mylike"><img src={heartIcon}/>완.내.스!</MyPageButton>
        <MyPageButton to="/"><img src={listIcon}/>서비스 소개</MyPageButton>
        <MyPageButton to="/"><img src={mailIcon}/>문의하기</MyPageButton>
      </MyPageBottom>
    </MyPage>
    </>
  );
